#!/usr/bin/env node
var listSourcemaps = require('../index').listSourcemaps

var yargs = require('yargs')
var argv = yargs
            .usage('$0 --applicationId=[ID] --apiKey=[apiKey]')
            .describe('applicationId', 'Browser application id (APPLICATION_ID)')
            .describe('apiKey', 'New Relic personal user API key (NR_API_KEY)')
            .describe('limit', 'Max number of results to return, default 20')
            .describe('offset', 'Number of results to skip before returning, default 0')
            .argv
...
listSourcemaps(options, function (err, response) {
  if (err) {
